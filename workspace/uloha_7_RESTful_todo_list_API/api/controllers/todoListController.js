...
exports.create_a_task = function(req, res){
    console.log("------------ create_a_task -----------------");
    var new_task = { name : "Matej", Created_date : "2015-03-25", status : "pending" };
...
exports.create_a_task = function(req, res){
    ...
    console.log("------------ create_a_task -----------------" + new_task);
    ...
    /*
    Task.create({name : "Matej", Created_date : "2015-03-25", status : "pending"}, function (err, small) {
